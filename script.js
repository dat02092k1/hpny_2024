...
const myWishToYou = "Happy New Year 2024. Nếu bạn nhận được lời chúc này, thì, bạn là một người rất đặc biệt và quan trọng trong cuộc sống của tôi. Dù bạn là ai, chúng ta từng học chung, chúng ta hay đi cà phê chill chill, chúng ta có cảm tình, chúng ta đã lâu không trò chuyện, chúng ta từng xảy ra nhiều bất đồng về quan điểm ý kiến, nhưng năm mới đã đến, chúng ta có thể nhìn nhau bằng con người mới, bỏ qua những hiểu lầm và cãi vã, tật xấu trong quá khứ, tha thứ, chia sẻ, gắn kết hơn. I know, it's life, people gotta move on, I hope you're safe. Năm mới vui vẻ, bạn của tôi!!!"; 

function myWishToBeloved() {
    alert(myWishToYou);
}
